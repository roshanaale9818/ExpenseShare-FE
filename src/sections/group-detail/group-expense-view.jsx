...
export default function GroupExpenseView({ groupMembers, isAdmin,group}) {
  ...
  return (
    <Card>
      {/* <CardHeader title={`Group Expense (${groupMembers.length})`} subheader='Expenses' sx={{mb:2}} /> */}
      <Container>
      <PageHeadView
          name="Group Expense"
          ...
          onNewClick={()=>{
            ...
            navigate(`/auth/group/${groupId}/expense?groupName=${group.groupName}`,group);
